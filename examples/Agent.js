exports.definition = {
  ...
  extendModel: function(Model) {
    _.extend(Model.prototype, {
      url: function() {
        return Alloy.CFG.environment_prefix + ".windermere.com/service/v1/profile/" + (this.get('id'));
      },
  ...
  extendCollection: function(Collection) {
    _.extend(Collection.prototype, {
      url: function() {
        return Alloy.CFG.environment_prefix + ".windermere.com/service/v1/profile/agents/search";
      },
